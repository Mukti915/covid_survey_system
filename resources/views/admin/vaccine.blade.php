...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Vaccine List
                <small>Vaccine List</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Vaccine List</a></li>
                                ...
                                @if(!empty($vaccine))
                                    @foreach($vaccine as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->vaccine_no }}</td>
                                            @if(\Illuminate\Support\Facades\Auth::user()->type == 2)
                                                <td>
                                                    <a href="{{ route("book_vaccine",$row->id ) }}" class="btn btn-success">Book</a>
                                                </td>
                                            @else
                                                <td>
                                                    <a href="{{ route("vaccine.edit",$row->id ) }}" class="btn btn-danger">Delete</a>
                                                </td>
            ...
            <form action="{{ route("vaccine.store") }}" method="post">
                ...
                <div class="modal-body">
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label for="">Number of Vaccine</label>
                            <input type="text" class="form-control" name="vaccine_no">
                        </div>
                    </div>
