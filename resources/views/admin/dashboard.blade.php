        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        <div class="inner">
                            <h3>{{ count($all_admitted)- count($admitted)}}</h3>
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                    <!-- small box -->
                    @php
                        $vaccine = isset($vaccin[0]->vaccine)?$vaccin[0]->vaccine:  0;
                         $total = isset($vaccin[0]->total)?$vaccin[0]->total:  0;
                    @endphp
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3>{{ $vaccine- count($vaccine_patient)}}</h3>

                            <p>Available Vaccine</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-stats-bars"></i>
                        </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua-gradient">
                        <div class="inner">
                            <h3>{{ count($vaccine_patient)}}</h3>

                            <p>Vaccined Patient</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-person-add"></i>
                        </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        <div class="inner">
                            ...
                            <p>Number of Vacine Transaction</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-pie-graph"></i>
                        </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-red">
                        <div class="inner">
                            ...
                            <p>Number of Complains/Feedback</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-pie-graph"></i>
                        </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        <div class="inner">
                            <h3>{{ count($bed) - count( $booked_bed)}}</h3>

                            <p>Number of Available Bed</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-pie-graph"></i>
                        </div>
