    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <h2>Registration</h2>
                <h5 style="color: white">It can save more life</h5>
            </div>
            <div class="col-md-6 col-lg-6">
...
<section id="section16" class="section16">
    <div class="container">
        <h3 class="text-center">Make Registration</h3>
        <hr>
        <br>
        <div class="row">
            <div class="col-md-8 col-lg-8">
                <form  role="form" action="{{ route("CovidRegistration.store") }}" method="post">
                    @csrf
                    <!-- successfully -->
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <input class="form-control"  type="number" name="phone" placeholder="+880">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
                            <textarea class="form-control"  type="number" name="address"
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <textarea class="form-control custom-control" id="cf-message" rows="4" name="details"
                                      placeholder="Details "></textarea>
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
                            <input type="checkbox" name="vaccine_ind" value="1" title=""> Have you affected by Covid'19? &nbsp; &nbsp; &nbsp;

                            <input type="checkbox" name="test_ind" value="1" title=""> Have you doing any test of Covid'19?&nbsp; &nbsp; &nbsp;
                            <input type="checkbox" name="vaccine_ind" value="1" title=""> Have you Take any Vaccine?&nbsp; &nbsp; &nbsp;
                        </div>
                    </div>
            ...
            <div class="col-md-4 col-lg-4">
                <img src="{{ asset("assets/images/registration.jpg") }}" width="1050px" alt=""
                     style="max-width: 143%!important;">
            </div>
