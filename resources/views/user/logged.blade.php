...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-6 col-md-offset-3" style="    background-color: #ffd6d6;
    border-radius: 25px;
    padding: 25px;
    margin-top: 100px;">
                    <h2 class="text-center">Hi, {{ \Illuminate\Support\Facades\Auth::user()->name }}</h2>
                    <h2 class="text-center">Welcome to Covid Medical</h2>
                    <h3 class="text-center">Thanks to joining us</h3>
                </div>
            </div>
        </section>
        <!-- /.content -->
